    ...
    <div className="flex justify-center w-screen h-screen bg-white to-gray-100">
      ...
      <Header title="여행 종류 선택"/>
        ...
        <div className="flex flex-row items-center gap-6 mt-6 mx-auto">
          ...
          >편도로 갈래요.</button>
          <button onClick = {handleStart}
          className="w-[180px] h-[200px] bg-yellow-100 text-yellow-700 hover:bg-yellow-200 border border-yellow-300 rounded-2xl shadow-md">왕복으로 갈래요.</button>
        </div>
